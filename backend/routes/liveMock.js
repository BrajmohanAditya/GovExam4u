...
router.post("/addCard", isLoggedIn, adminRoles("editor", "admin"), addCard);
router.get("/getCards", getCards);
router.get("/:id/bringCard", isLoggedIn, adminRoles("editor", "admin"), bringCard); // bringing single card by id
router.put("/:id/updateCard", isLoggedIn, adminRoles("editor", "admin"), updateCard); // updating card by id
router.delete("/:id/deleteCard", isLoggedIn, adminRoles("editor", "admin"), deleteCard); // deleting card by id
